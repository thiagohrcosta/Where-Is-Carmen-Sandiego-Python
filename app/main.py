...
def first_message():
    ...
    print("")
    print("Carmen Sandiego has stolen a valuable object from the museum!")
...
def trying_to_arrest_carmen_sandiego():
    ...
    if detective_experience < 3:
        print(
            f"You have only {detective_experience}, she is too strong for you. She scape from you."
        )
        print("You don't loose life points this time.")
        carmen_sandiego_life = carmen_sandiego_life - 1

        print(
            f"Carmen Sandiego loose 1 life point. Now she has {carmen_sandiego_life} life points."
        )
        ...
        print(
            f"LEVEL UP! You are now a Detective! You have {detective_life} life points and {detective_experience} experiences."
        )
    else:
        ...
        print(
            f"Carmen Sandiego loose 3 life points. Now she has {carmen_sandiego_life} life points."
        )


def setup():
    print(
        f"Detective life: {detective_life}                              Carmen Sandiego life: {carmen_sandiego_life}"
    )
